...
public class OrderItemV3Controller {
    private final OrderItemV3Service orderItemV3Service;
    ...
    public ResponseEntity<Page<OrderItemResponseDto>> getOrderItemList(
        ...
        return ResponseEntity.ok(orderItemV3Service.getOrderItemList(userOrStreamerId, userRole, pageable));
    }
}
