...
@RequestMapping("/api/v4/items")
public class ItemV4Controller {

	private final ItemV4Service itemV4Service;
	...
	public ResponseEntity<GetItemListResponseDtoV2> getItemList(
		...
		GetItemListResponseDtoV2 responseDto = itemV4Service.getItemList(minPrice, maxPrice, itemName, storeId, cursor, limit);
